"""
Django settings for firsthand_auction project.
...
SECRET_KEY = 'django-insecure-8qjx-_1^0dnym@c)(_ru!s&#@3h%ox@w-tusl62u!ykzj1+*)4'
...
ROOT_URLCONF = 'firsthand_auction.urls'
...
LOGIN_REDIRECT_URL = '/success'               # redirect url after login


WSGI_APPLICATION = 'firsthand_auction.wsgi.application'
